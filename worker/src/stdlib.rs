    ...
    vec![
        StdModule {
            ...
            helpers: vec![
                helper(
                    "cube",
                    "commands.cube(position, color)",
                    "Spawn a cube and color it.",
                    "commands",
                ),
                helper(
                    "sphere",
                    "commands.sphere(position, radius, color)",
                    "Spawn a sphere and color it.",
                    "commands",
                ),
                helper(
                    "glowing",
                    "commands.glowing(position, color, strength)",
                    "Spawn an emissive sphere.",
                    "commands",
                ),
                helper(
                    "grid",
                    "commands.grid(columns, rows, spacing, color)",
                    "A centered grid of cubes.",
                    "commands",
                ),
                helper(
                    "ring",
                    "commands.ring(count, radius, color)",
        ...
        StdModule {
            ...
            helpers: vec![
                helper(
                    "spin",
                    "commands.spin(entity, speed, dt)",
                    "Spin about Y by speed * dt.",
                    "commands",
                ),
                helper(
                    "spin_axis",
                    "commands.spin_axis(entity, axis, speed, dt)",
                    "Spin about an axis.",
                    "commands",
                ),
                helper(
                    "bob",
                    "commands.bob(entity, base_y, amplitude, frequency, time)",
                    "Bob vertically.",
                    "commands",
                ),
                helper(
                    "orbit",
                    "commands.orbit(entity, center, radius, speed, time)",
                    "Move in a circle.",
                    "commands",
                ),
            ],
        ...
        StdModule {
            ...
            helpers: vec![
                helper(
                    "hits",
                    "events.hits(self)",
                    "Collisions starting this frame for self.",
                    "events",
                ),
                helper(
                    "sensor_hits",
                    "events.sensor_hits(self)",
                    "Sensor overlaps starting for self.",
                    "events",
                ),
                helper(
                    "other",
                    "other(event, self)",
                    "The other party in a collision.",
                    "free",
                ),
            ],
        },
        StdModule {
            ...
            helpers: vec![
                helper(
                    "axis_x",
                    "axis_x(keys)",
                    "Left/right axis from A/D or arrows.",
                    "free",
                ),
                helper(
                    "axis_z",
                    "axis_z(keys)",
                    "Forward/back axis from W/S or arrows.",
                    "free",
                ),
                helper(
                    "held",
                    "held(keys, code)",
                    "Whether a key code is held.",
                    "free",
                ),
            ],
        },
