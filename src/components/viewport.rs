//! The render surface. Transfers the canvas to the engine worker on first
//! layout, then forwards pointer, touch, and wheel input so the engine drives
//! the camera off the main thread. A click or tap without drag picks.
